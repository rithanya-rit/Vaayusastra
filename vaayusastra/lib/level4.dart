...
class Level4DetailPage extends StatefulWidget {
  @override
  _Level4DetailPageState createState() => _Level4DetailPageState();
}

class _Level4DetailPageState extends State<Level4DetailPage> {
  ...
  void _provideBotResponse(String message) {
    ...
    if (message.toLowerCase().contains('what are the payment options available?')) {
      ...
      response = 'We offer courses in Spacecraft Design, Advanced Orbital Mechanics, and Space Mission Analysis.';
      ...
      body: ListView(
        children: [
          CourseCard(
            ...
            description: 'Explore the principles and techniques of spacecraft design and engineering.',
            driveLink: 'https://drive.google.com/spacecraft-design-link',
          ),
          CourseCard(
            title: 'Advanced Orbital Mechanics',
            description: 'Study complex orbital mechanics topics related to satellite trajectories and space exploration.',
            driveLink: 'https://drive.google.com/orbital-mechanics-link',
          ),
          CourseCard(
            title: 'Space Mission Analysis',
            description: 'Learn about the planning and analysis of space missions, including mission design and execution.',
            driveLink: 'https://drive.google.com/space-mission-analysis-link',
          ),
        ],
      ),
      backgroundColor: Colors.blueGrey[900],
